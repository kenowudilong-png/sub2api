          ...
          <div class="space-y-4 p-4">
            ...
            <div
              v-if="
                ...
                !subscription.group?.monthly_limit_usd
              "
              class="flex items-center justify-center rounded-xl bg-gradient-to-r from-primary-50 to-amber-50 py-6 dark:from-primary-500/10 dark:to-amber-500/10"
            >
              <div class="flex items-center gap-3">
                <span class="text-4xl text-primary-600 dark:text-primary-300">∞</span>
                <div>
                  <p class="text-sm font-medium text-primary-700 dark:text-primary-300">
                    {{ t('userSubscriptions.unlimited') }}
                  </p>
                  <p class="text-xs text-primary-600/75 dark:text-primary-300/75">
